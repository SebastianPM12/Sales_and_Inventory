...
import Controlador.Inventario.PersonalController;
 ...
 * @author SEBAS
 */
public class VentanaPersonalnventario extends javax.swing.JFrame {

    /**
     * Creates new form VentanaProductos
     */
    public VentanaPersonalnventario() {
        initComponents();
        this.setLocationRelativeTo(null);
        PersonalInventario psi = new PersonalInventario();
        PersonalInventariodao pdao = new PersonalInventariodao();
        PersonalController pc = new PersonalController(this, psi, pdao);
    ...
    private void initComponents() {
        ...
        jLabel10.setText("DETALLE DE PERSONAL");

        buttonEliminar.setText("ELIMINAR");

        jLabel12.setText("POSICION:");

        cmbPosicion.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "...POSICION...", "INVENTARIADO", "SUPERVISOR", "GERENTE" }));
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(fieldDni, javax.swing.GroupLayout.DEFAULT_SIZE, 215, Short.MAX_VALUE)
                                .addComponent(jLabel12)
                                .addComponent(cmbPosicion, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addComponent(jLabel14)
                            .addComponent(fieldcelular, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel5.setText("Id del personal:");
        ...
        tablaPersonal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DNI", "NOMBRES", "APELLIDOS", "DNI", "CELULAR", "POSICION"
            }
        ));
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/personal.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaPersonalnventario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaPersonalnventario().setVisible(true);
            }
        });
    }
