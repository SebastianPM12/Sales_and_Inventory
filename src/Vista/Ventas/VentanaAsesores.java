 ...
 * @author SEBAS
 */
public class VentanaAsesores extends javax.swing.JFrame {

    /**
     * Creates new form VentanaProductos
     */
    public VentanaAsesores() {
        initComponents();
        this.setLocationRelativeTo(null);
        Asesor a = new Asesor();
        AsesorDao adao = new AsesorDao();
        AsesorController asc = new AsesorController(this, a, adao);
    ...
    private void initComponents() {
        ...
        jLabel10.setText("DETALLE DE ASESORES");
        ...
        jLabel1.setText("LISTA DE ASESORES");
        ...
        jScrollPane1.setViewportView(tablaAsesores);
        ...
        jLabel11.setText("ASESORES");

        jLabel13.setBackground(new java.awt.Color(255, 255, 255));
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/asesor-financiero.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAsesores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaAsesores().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTable tablaAsesores;
